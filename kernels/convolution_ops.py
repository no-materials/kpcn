...
def KPConv_ops(query_points,
    ...
    # Concat Fake feature in last row for shadow neighbors
...
def KPConv_deformable(query_points,
    ...
    # Create independent weight for the first convolution and a bias term as no batch normalization happen
    if modulated:
    ...
    # Get features from standard convolution [n_pnts, 3*n_KP]
